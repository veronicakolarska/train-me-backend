namespace TrainMe.Data.Models
{
    ...
    public class ExerciseInstance : AuditableEntity
    {
        ...
        {
            this.ExerciseInstancesInProgramInstance = new HashSet<ExerciseInstanceInWorkoutDayInstance>();
        }
        ...
        public ICollection<ExerciseInstanceInWorkoutDayInstance> ExerciseInstancesInProgramInstance { get; set; }
    }
}