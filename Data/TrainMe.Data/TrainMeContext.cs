namespace TrainMe.Data
{
    ...
    public class TrainMeContext : DbContext
    {
        ...
        public DbSet<WorkoutDayInstance> WorkoutDayInstances { get; set; }

        public DbSet<ExerciseInstanceInWorkoutDayInstance> ExerciseInstancesInWorkoutDayInstances { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ApplyConfiguration(new ExerciseInWorkoutDayConfiguration());
            modelBuilder.ApplyConfiguration(new ExerciseInstanceInWorkoutDayInstanceConfiguration());
            modelBuilder.ApplyConfiguration(new WorkoutDayConfiguration());
